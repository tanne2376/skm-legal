...
These Terms of Service ("Terms") govern your use of the Switch-Kick
Mafia mobile booking app (the "App"). By creating an account you agree
to these Terms.

## 1. Account

You must be 18 or over, or have permission from a parent or guardian,
to create an account. You are responsible for keeping your sign-in
details confidential and for activity that happens under your account.

## 2. Bookings and payment

- Class and 1-to-1 prices are shown in the App in GBP and include any
  applicable taxes.
- Payment is processed by Stripe. Apple Pay and Google Pay are
  supported where available. Cash payment may be confirmed in-person
  by a teacher or admin.
- Memberships renew automatically each month until cancelled.
...
disrupt or compromise the service; impersonate another person; or
interfere with other users' bookings.
...
[Privacy Policy](privacy.html) for what happens to your data on
deletion.
...
To the extent permitted by law, Switch-Kick Mafia is not liable for
any loss or damage arising from your use of the App or participation
in classes, except where caused by our negligence in respect of death
or personal injury. Nothing in these Terms limits your statutory
rights as a consumer.

## 9. Changes

We may update these Terms. If we make material changes we will update
the "Last updated" date and, where appropriate, notify you in the
App. Continued use of the App after changes means you accept the new
Terms.
